---
title: "Bycatch analyses of the Spanish purse-seine tuna fishery"
...
MOD1 [label = 'sdmTMB model \n &Delta; LN (&epsilon; and &omega;)', fillcolor = Pink];
...
Using fitted models, we can simulate new values with observation error keeping the statistical properties and patterns of the data.
...
![FOB set type](../figures/3_sampsize/FOB/nyr_missing.png){fig-align="center"}
...
Implemented using the R package *tinyVAST* [@thorsonTinyVASTPackageExpressive2025]. The model follows a hurdle approach can be represented, for each component, as:
