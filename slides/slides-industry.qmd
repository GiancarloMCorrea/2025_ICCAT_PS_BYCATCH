...
author: Giancarlo M. Correa, Jon Ruiz, María Lourdes Ramos
...
![FOB set type (billfish)](../figures/1_single/FOB/compare_estimates_billfishes.png){fig-align="center"}
...
![FSC set type](../figures/1_single/FSC/compare_estimates.png){fig-align="center"}

## Preliminary results

![FSC set type (billfish)](../figures/1_single/FSC/compare_estimates_billfishes.png){fig-align="center"}

## Discussion

::: incremental

- Assuming linear relationship between bycatch and target catch (at the set level) may not be appropiate
- Modelling approach not suitable for *rare* taxa and demans fine-scale data
